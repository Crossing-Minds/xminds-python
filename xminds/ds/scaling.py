...
def linearscaling(x, new_min, new_max, old_min=None, old_max=None, axis=None):
    ...
    :param scalar-or-array x:  scalar or arrays of scalars in ``[old_min, old_max]`` of shape (n, d)
    :param scalar-or-array new_min: scalar or array of shape (d,)
    :param scalar-or-array new_max: scalar or array of shape (d,)
    :param scalar-or-array? old_min: (``default=x.min()``)
    :param scalar-or-array? old_max: (``default=x.max()``)
    :param int? axis: (``default=None``)
    :return: scalar or array of scalars in ``[new_min, new_max]`` of shape (n, d)
